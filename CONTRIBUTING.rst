...
Report bugs at https://github.com/romnn/npm-package-validator/issues.
...
The best way to send feedback is to `file an issue <https://github.com/romnn/npm-package-validator/issues>`_ on GitHub.
...
1. Fork the `npm_package_validator repo <https://github.com/romnn/npm-package-validator>`_ on GitHub.
...
3. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://travis-ci.com/romnn/npm-package-validator/pull_requests>`_
...
.. _GitHub issues: https://github.com/romnn/npm-package-validator/issues
